    ...
    { get: 'compute-image-tools' },
    {
      in_parallel: {
        steps: [
          ...
          buildpackageimagetask {
            image_name: 'ubuntu-pro-1804-lts-arm64',
            source_image: 'projects/ubuntu-os-pro-cloud/global/images/family/ubuntu-pro-1804-lts-arm64',
            dest_image: 'ubuntu-pro-1804-lts-arm64-((.:build-id))',
            gcs_package_path: 'gs://gcp-guest-package-uploads/%s/google-guest-agent_((.:package-version))-g1_arm64.deb' % [tl.package],
            machine_type: 'c4a-standard-2',
            disk_type: 'hyperdisk-balanced',
            worker_image: 'projects/compute-image-tools/global/images/family/debian-12-worker-arm64',
          ...
          buildpackageimagetask {
            image_name: 'ubuntu-pro-2004-lts-arm64',
            source_image: 'projects/ubuntu-os-pro-cloud/global/images/family/ubuntu-pro-2004-lts-arm64',
            dest_image: 'ubuntu-pro-2004-lts-arm64-((.:build-id))',
            gcs_package_path: 'gs://gcp-guest-package-uploads/%s/google-guest-agent_((.:package-version))-g1_arm64.deb' % [tl.package],
            machine_type: 'c4a-standard-2',
            disk_type: 'hyperdisk-balanced',
            worker_image: 'projects/compute-image-tools/global/images/family/debian-12-worker-arm64',
          ...
          buildpackageimagetask {
            ...
            source_image: 'projects/centos-cloud/global/images/family/centos-stream-10-arm64',
          ...
          buildpackageimagetask {
            ...
            source_image: 'projects/rhel-byos-cloud/global/images/family/rhel-10-byos',
          ...
          buildpackageimagetask {
            ...
            source_image: 'projects/rhel-byos-cloud/global/images/family/rhel-10-byos-arm64',
          ...
          buildpackageimagetask {
            image_name: 'rocky-linux-10-arm64',
            source_image: 'projects/rocky-linux-cloud/global/images/family/rocky-linux-10-arm64',
            dest_image: 'rocky-linux-10-arm64-((.:build-id))',
            gcs_package_path: 'gs://gcp-guest-package-uploads/%s/google-guest-agent-((.:package-version))-g1.el10.aarch64.rpm' % [tl.package],
            machine_type: 'c4a-standard-2',
            disk_type: 'hyperdisk-balanced',
            worker_image: 'projects/compute-image-tools/global/images/family/debian-12-worker-arm64',
          ...
          buildpackageimagetask {
            ...
            dest_image: 'rocky-linux-10-opti-((.:build-id))',
            gcs_package_path: 'gs://gcp-guest-package-uploads/%s/google-guest-agent-((.:package-version))-g1.el10.x86_64.rpm' % [tl.package],
            worker_image: 'projects/compute-image-tools/global/images/family/debian-12-worker',
          },
          buildpackageimagetask {
            image_name: 'rocky-linux-10-optimized-gcp-arm64',
            source_image: 'projects/rocky-linux-cloud/global/images/family/rocky-linux-10-optimized-gcp-arm64',
            dest_image: 'rocky-linux-10-opti-arm64-((.:build-id))',
            gcs_package_path: 'gs://gcp-guest-package-uploads/%s/google-guest-agent-((.:package-version))-g1.el10.aarch64.rpm' % [tl.package],
            machine_type: 'c4a-standard-2',
            disk_type: 'hyperdisk-balanced',
            worker_image: 'projects/compute-image-tools/global/images/family/debian-12-worker-arm64',
...
local build_and_upload_oslogin = buildpackagejob {
  ...
  local oslogin_arm_images = [
    ...
    'projects/guest-package-builder/global/images/rhel-8-arm64-((.:build-id))',
    'projects/guest-package-builder/global/images/rhel-9-arm64-((.:build-id))',
    'projects/guest-package-builder/global/images/rhel-9-6-eus-arm64-((.:build-id))',
    'projects/guest-package-builder/global/images/rhel-10-arm64-((.:build-id))',
    'projects/guest-package-builder/global/images/rhel-10-0-eus-arm64-((.:build-id))',
  ],
    ...
    { get: 'compute-image-tools' },
    {
      in_parallel: {
        ...
        steps: [
          ...
          buildpackageimagetask {
            image_name: 'rhel-9-6-eus-arm64',
            source_image: 'projects/rhel-cloud/global/images/family/rhel-9-6-eus-arm64',
            dest_image: 'rhel-9-6-eus-arm64-((.:build-id))',
            gcs_package_path: 'gs://gcp-guest-package-uploads/oslogin/google-compute-engine-oslogin-((.:package-version))-g1.el9.aarch64.rpm',
            machine_type: 'c4a-standard-2',
            disk_type: 'hyperdisk-balanced',
            worker_image: 'projects/compute-image-tools/global/images/family/debian-12-worker-arm64',
          ...
          buildpackageimagetask {
            image_name: 'rhel-10-0-eus-arm64',
            source_image: 'projects/rhel-cloud/global/images/family/rhel-10-0-eus-arm64',
            dest_image: 'rhel-10-0-eus-arm64-((.:build-id))',
            gcs_package_path: 'gs://gcp-guest-package-uploads/oslogin/google-compute-engine-oslogin-((.:package-version))-g1.el10.aarch64.rpm',
            machine_type: 'c4a-standard-2',
            disk_type: 'hyperdisk-balanced',
            worker_image: 'projects/compute-image-tools/global/images/family/debian-12-worker-arm64',
